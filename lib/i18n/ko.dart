...
const Map<String, String> koTexts = {
  ...
  'shift_apps_picker_link': '이 근무의 앱 선택',
  'shift_apps_picker_title': '긱 앱 선택',
  'shift_apps_picker_body': '자동 감지는 선택한 앱에만 반응합니다. 모든 앱을 감지하려면 아무것도 선택하지 마세요.',
  'shift_apps_picker_clear': '지우기',
  'shift_apps_picker_save': '저장',
  'background_reliability_section': '백그라운드 안정성',
  'battery_optimization_title': '배터리 최적화',
  'battery_optimization_granted': '백그라운드 실행이 허용됨',
  'battery_optimization_missing': '백그라운드에서 일시 중지될 수 있음, 수정하려면 탭하세요',
  'exact_alarm_title': '정확한 알람',
  'exact_alarm_granted': '알림이 제시간에 울립니다',
  'exact_alarm_missing': '알림이 지연될 수 있음, 수정하려면 탭하세요',
  ...
  'photo_blurry_warning': '이 사진이 흐릿해 보입니다. 선명한 기록을 위해 다시 촬영하세요.',
  'retake_photo': '다시 촬영',
  'use_photo': '사진 사용',
  'use_photo_anyway': '그래도 사용',
