...
const Map<String, String> frTexts = {
  ...
  'auto_trip_notification_tap_hint': 'Appuyez pour confirmer et enregistrer le compteur maintenant.',
  ...
  'mid_trip_switch_suggested_title': 'Autre application détectée',
  'mid_trip_switch_suggested_body': 'Ouvrez ControlMiles pour passer à',
  ...
  'auto_detect_tap_to_switch': 'Touchez pour changer',
  ...
  'auto_switch_toggle_title': 'Changer d\'application automatiquement',
  'auto_switch_toggle_subtitle': 'Change automatiquement au lieu de demander d\'abord',
  ...
  'irs_estimate_disclaimer': 'Estimation basée sur le taux kilométrique standard IRS 2026 (\$0.725/mile). ControlMiles n\'est affilié à aucune agence officielle, y compris l\'IRS, et n\'est pas approuvé par celle-ci. Ceci est une estimation informative uniquement, pas une déduction garantie — consultez un professionnel fiscal.',
