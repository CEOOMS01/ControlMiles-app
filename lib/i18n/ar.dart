...
const Map<String, String> arTexts = {
 ...
 // ============================================================
  ...
  'shift_apps_picker_link': 'اختر التطبيقات لهذه الوردية',
  'shift_apps_picker_title': 'اختيار تطبيقات العمل الحر',
  'shift_apps_picker_body': 'سيتفاعل الكشف التلقائي فقط مع التطبيقات التي تحددها. اترك الكل بدون تحديد لمراقبة جميع التطبيقات.',
  'shift_apps_picker_clear': 'مسح',
  'shift_apps_picker_save': 'حفظ',
  'background_reliability_section': 'الموثوقية في الخلفية',
  'battery_optimization_title': 'تحسين البطارية',
  'battery_optimization_granted': 'مسموح بالعمل في الخلفية',
  'battery_optimization_missing': 'قد يتم إيقافه مؤقتًا في الخلفية، اضغط للإصلاح',
  'exact_alarm_title': 'المنبهات الدقيقة',
  'exact_alarm_granted': 'ستنطلق التذكيرات في الوقت المحدد',
  'exact_alarm_missing': 'قد تتأخر التذكيرات، اضغط للإصلاح',
