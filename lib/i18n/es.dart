...
const Map<String, String> esTexts = {
  ...
  'premium_plan_description': 'Desbloquea la Detección Automática y otras funciones premium. Hasta 5 vehículos. Incluye una prueba gratuita de 5 días.',
  'base_plan_description': 'La experiencia principal de ControlMiles. 1 vehículo.',
  'current_plan': 'Plan actual',
  'started_plan': 'Started (prueba gratis)',
  'started_plan_description': 'Tu prueba gratuita de 15 días. 1 vehículo.',
  ...
  'shift_apps_picker_link': 'Elegir apps para este turno',
  'shift_apps_picker_title': 'Seleccionar apps de gig',
  'shift_apps_picker_body': 'La detección automática solo reaccionará a las apps que selecciones. Deja todo sin marcar para vigilar todas las apps.',
  'shift_apps_picker_clear': 'Borrar',
  'shift_apps_picker_save': 'Guardar',
  'background_reliability_section': 'Confiabilidad en segundo plano',
  'battery_optimization_title': 'Optimización de batería',
  'battery_optimization_granted': 'Permitido ejecutarse en segundo plano',
  'battery_optimization_missing': 'Puede pausarse en segundo plano, toca para arreglarlo',
  'exact_alarm_title': 'Alarmas exactas',
  'exact_alarm_granted': 'Los recordatorios sonarán a tiempo',
  'exact_alarm_missing': 'Los recordatorios pueden retrasarse, toca para arreglarlo',
  ...
  'photo_blurry_warning': 'Esta foto se ve borrosa. Vuelve a tomarla para un registro claro y utilizable.',
  'retake_photo': 'Repetir foto',
  'use_photo': 'Usar foto',
  'use_photo_anyway': 'Usar de todos modos',
  ...
  'fuel_log_purchase_title': 'Registrar carga de combustible',
  'fuel_log_purchase_button': 'Registrar combustible',
  'fuel_tap_to_scan_receipt': 'Toca para escanear un recibo',
  'fuel_retake_photo': 'Volver a tomar la foto',
  'fuel_gallons_label': 'Galones',
  'fuel_price_per_gallon_label': 'Precio por galón',
  'fuel_total_cost_label': 'Costo total',
  'fuel_state_label': 'Estado',
  'fuel_state_hint': 'Selecciona el estado',
  'fuel_date_label': 'Fecha de compra',
  'fuel_save_purchase': 'Guardar compra',
  'fuel_receipt_photo_required': 'Primero toma una foto del recibo.',
  'fuel_gallons_required': 'Ingresa cuántos galones compraste.',
  ...
  'vin_label': 'VIN',
  'odometer_cycle_label': 'Ciclo de odómetro',
  'odometer_cycle_weekly': 'Semanal',
  'odometer_cycle_biweekly': 'Quincenal',
  'odometer_cycle_monthly': 'Mensual',
  'odometer_cycle_updated': 'Ciclo de odómetro actualizado.',
  ...
  'notification_types_manage_hint': 'Toca para elegir qué avisos recibir',
