...
const Map<String, String> jaTexts = {
  ...
  'vin_label': 'VIN',
  'odometer_cycle_label': 'オドメーターサイクル',
  'odometer_cycle_weekly': '毎週',
  'odometer_cycle_biweekly': '隔週',
  'odometer_cycle_monthly': '毎月',
  'odometer_cycle_updated': 'オドメーターサイクルを更新しました。',
  ...
  'shift_apps_picker_link': 'このシフトのアプリを選択',
  'shift_apps_picker_title': 'ギグアプリを選択',
  'shift_apps_picker_body': '自動検出は選択したアプリにのみ反応します。すべてのアプリを検出するには何も選択しないでください。',
  'shift_apps_picker_clear': 'クリア',
  'shift_apps_picker_save': '保存',
  'background_reliability_section': 'バックグラウンドの信頼性',
  'battery_optimization_title': 'バッテリー最適化',
  'battery_optimization_granted': 'バックグラウンド実行が許可されています',
  'battery_optimization_missing': 'バックグラウンドで一時停止される可能性があります、タップして修正',
  'exact_alarm_title': '正確なアラーム',
  'exact_alarm_granted': 'リマインダーは時間通りに届きます',
  'exact_alarm_missing': 'リマインダーが遅れる可能性があります、タップして修正',
  'checking_status': '確認中...',
  'fix_it': '修正',
  ...
  'photo_blurry_warning': 'この写真はぼやけているようです。鮮明な記録のために撮り直してください。',
  'retake_photo': '撮り直す',
  'use_photo': 'この写真を使用',
  'use_photo_anyway': 'このまま使用',
